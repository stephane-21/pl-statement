...
from misc.config import MANUAL_BLOCKS
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DG_1_cleaned.xlsx")
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DG_2_cleaned.xlsx")
TABLE.to_excel(writer, "TABLE", header=True, index=False)
writer.save()
del(writer)
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DG_3_extraction_id.xlsx")
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DG_4_extraction_single.xlsx")
TABLE.to_excel(writer, "Todo", header=True, index=False)
pandas.DataFrame.from_dict(TABLE_2).reindex(columns= block_columns_list()).to_excel(writer, "Done", header=True, index=False)
writer.save()
del(writer)
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DG_5_extraction_curr.xlsx")
TABLE.to_excel(writer, "Todo", header=True, index=False)
pandas.DataFrame.from_dict(TABLE_2).reindex(columns= block_columns_list()).to_excel(writer, "Done", header=True, index=False)
writer.save()
del(writer)
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DG_6_extraction_div.xlsx")
TABLE.to_excel(writer, "Todo", header=True, index=False)
pandas.DataFrame.from_dict(TABLE_2).reindex(columns= block_columns_list()).to_excel(writer, "Done", header=True, index=False)
writer.save()
del(writer)
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DG_7_profits.xlsx")
TABLE.to_excel(writer, "Todo", header=True, index=False)
