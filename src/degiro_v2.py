...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DGb_1_cleaned.xlsx")
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DGb_2_formatted.xlsx")
...
print("Export XLS")
print("=================================")
writer = pandas.ExcelWriter("output/output_DGb_3_profits.xlsx")
pandas.DataFrame.from_dict(TABLE).to_excel(writer, "TABLE", header=True, index=False)
